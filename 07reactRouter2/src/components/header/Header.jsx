            ...
            <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    <div className="flex items-center lg:order-2">
                        <Link
                            to="/Login"
                            className="text-gray-800 hover:bg-gradient-to-r from-cyan-600 to-blue-300 focus:ring-4 focus:ring-gray-300 font-medium  rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 focus:outline-none"
                        >
                            Log in
                        </Link>
                        <Link
                            ...
                            className="text-white bg-blue-700 
                             hover:bg-blue-800 focus:ring-4 focus:rinblue-300
                    ...
                    <div
                        className="justify-between flex-wrap items-center w-full lg:flex lg:w-auto"
                        id="mobile-menu-2"
                    >
                        <ul className="flex flex-col mt-4 font-medium sm:flex-row sm:space-x-8 sm:mt-0">
                            ...
                            <li>
                                ...
                                to="/About"
                                    className={(isActive) =>
                                        ...
                                        duration-200${isActive ? "textbluge-700" 
                            ...
                            <li>
                                ...
                                to="/Contact"
                                    className={(isActive) =>
                                        `block py-2 pr-4 pl-3 
                                        duration-200${isActive ? "text-blue-700" 
                                        : "text-gray-700" } border-b
                                         border-gray-100 hover:bg-gray-50 
                                         lg:hover:bg-transparent lg:border-0
                                          hover:text-blue-700 lg:p-0`
